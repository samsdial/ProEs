      ...
      <div className="container text-center">
        <div className="row justify-content-between mb-4">
          ...
          <div className="col-md-2 text-right">  
            ...
            {links.map((link) => (
              <a key={link.id} href={link.href} className="text-white text-right nav-link px-0">
                {link.text}
              </a>
            ))}
          </div>
          <div className="col-md-2 text-right">
            ...
            {social.map((link) => (
              <a key={link.id} href={link.href} target="_blank"  className="text-white text-right nav-link  px-0" rel="noreferrer">
                {link.text}
              </a>
            ))}
          </div>
        ...
        <div className="row justify-content-between">
          <div className="col-md text-center">  
            <a href={copy.link} target="_blank"  className="navbar-brand text-gray d-block" rel="noreferrer">
