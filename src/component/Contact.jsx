            ...
            <div className="row justify-content-between">
                ...
                <div className="col-lg-4 pt-5">
                    <div className="mb-5">
                        ...
                        <div className="paragraf">
                            <a href={contact.phone.link}  target="_blank" className="text-body" rel="noreferrer">
                                {contact.phone.number} 
                            </a>
                            <span className="text-body mx-3 d-block d-lg-inline-block">/</span>
                            <a href={contact.email.link} target="_blank" className="text-body" rel="noreferrer">
                                {contact.email.text}
                            </a>
                            <hr />
                        </div>
                    ...
                    <div className="mb-5">
                        ...
                        <div className="paragraf">
                            <a href={contact.address.link} target="_blank" className="text-body" rel="noreferrer">
